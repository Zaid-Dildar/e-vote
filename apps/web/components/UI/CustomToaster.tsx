            ...
            <>
              ...
              {t.type !== "loading" && (
                <button
                  ...
                  className="cursor-pointer bg-red-500 overflow-hidden relative text-white px-2 py-1 shadow-2xl rounded group hover:bg-gradient-to-r hover:from-red-600 hover:to-red-500"
                >
